...
const moduleOptions = JSON.parse('{"i18n":{"useNuxtI18nConfig":true},"locale":"es","currency":"USD","country":"US","acceptLanguage":["en","de","es"],"countries":[{"name":"US","label":"United States"},{"name":"AT","label":"Austria"},{"name":"DE","label":"Germany"},{"name":"NL","label":"Netherlands"}],"currencies":[{"name":"EUR","label":"Euro"},{"name":"USD","label":"Dollar"}],"locales":[{"name":"en","label":"English"},{"name":"de","label":"German"},{"name":"es","label":"Español"}]}');
